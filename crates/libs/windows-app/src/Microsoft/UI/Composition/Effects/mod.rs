...
unsafe impl ::windows_core::ComInterface for ISceneLightingEffect {
    const IID: ::windows_core::GUID =
        ::windows_core::GUID::from_u128(0xeb1e7316_114c_5950_8480_20a29a3bb1ee);
}
#[repr(C)]
#[doc(hidden)]
pub struct ISceneLightingEffect_Vtbl {
    ...
    #[cfg(feature = "Windows_Graphics_Effects")]
    pub NormalMapSource: unsafe extern "system" fn(
        this: *mut ::core::ffi::c_void,
        result__: *mut *mut ::core::ffi::c_void,
    ) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Windows_Graphics_Effects"))]
...
unsafe impl ::windows_core::ComInterface for ISceneLightingEffect2 {
    const IID: ::windows_core::GUID =
        ::windows_core::GUID::from_u128(0x6b6496b2_468d_50d1_bbe9_593b8263ad80);
}
#[repr(C)]
#[doc(hidden)]
...
impl SceneLightingEffect {
    ...
    #[doc = "Required features: `\"Windows_Graphics_Effects\"`"]
    #[cfg(feature = "Windows_Graphics_Effects")]
    ...
    where
        P0: ::windows_core::TryIntoParam<::windows::Graphics::Effects::IGraphicsEffectSource>,
    {
        let this = self;
        unsafe {
...
#[cfg(feature = "Windows_Graphics_Effects")]
impl ::windows_core::CanTryInto<::windows::Graphics::Effects::IGraphicsEffect>
    for SceneLightingEffect
{
}
#[cfg(feature = "Windows_Graphics_Effects")]
impl ::windows_core::CanTryInto<::windows::Graphics::Effects::IGraphicsEffectSource>
    for SceneLightingEffect
{
}
