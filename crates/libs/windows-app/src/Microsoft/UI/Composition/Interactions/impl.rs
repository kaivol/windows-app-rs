...
impl ICompositionInteractionSource_Vtbl {
    pub const fn new<
        ...
        Impl: ICompositionInteractionSource_Impl,
        const OFFSET: isize,
...
pub trait IInteractionTrackerOwner_Impl: Sized {
    fn CustomAnimationStateEntered(
        &self,
        sender: &::core::option::Option<InteractionTracker>,
        args: &::core::option::Option<InteractionTrackerCustomAnimationStateEnteredArgs>,
    ) -> ::windows::core::Result<()>;
    fn IdleStateEntered(
        &self,
        sender: &::core::option::Option<InteractionTracker>,
        args: &::core::option::Option<InteractionTrackerIdleStateEnteredArgs>,
    ) -> ::windows::core::Result<()>;
    fn InertiaStateEntered(
        &self,
        sender: &::core::option::Option<InteractionTracker>,
        args: &::core::option::Option<InteractionTrackerInertiaStateEnteredArgs>,
    ) -> ::windows::core::Result<()>;
    fn InteractingStateEntered(
        &self,
        sender: &::core::option::Option<InteractionTracker>,
        args: &::core::option::Option<InteractionTrackerInteractingStateEnteredArgs>,
    ) -> ::windows::core::Result<()>;
    fn RequestIgnored(
        &self,
        sender: &::core::option::Option<InteractionTracker>,
        args: &::core::option::Option<InteractionTrackerRequestIgnoredArgs>,
    ) -> ::windows::core::Result<()>;
    fn ValuesChanged(
        &self,
        sender: &::core::option::Option<InteractionTracker>,
        args: &::core::option::Option<InteractionTrackerValuesChangedArgs>,
    ) -> ::windows::core::Result<()>;
}
...
impl IInteractionTrackerOwner_Vtbl {
    pub const fn new<
        Identity: ::windows::core::IUnknownImpl<Impl = Impl>,
        Impl: IInteractionTrackerOwner_Impl,
        const OFFSET: isize,
