pub trait IAutomationPeerOverrides_Impl: Sized {
    ...
    fn GetBoundingRectangleCore(&self) -> ::windows::core::Result<::windows::Foundation::Rect>;
    fn GetChildrenCore(
        &self,
    ) -> ::windows::core::Result<::windows::Foundation::Collections::IVector<AutomationPeer>>;
    fn NavigateCore(
        &self,
        direction: AutomationNavigationDirection,
    ) -> ::windows::core::Result<::windows::core::IInspectable>;
    fn GetClassNameCore(&self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn GetClickablePointCore(&self) -> ::windows::core::Result<::windows::Foundation::Point>;
    ...
    ) -> ::windows::core::Result<AutomationPeer>;
    ...
    fn GetControlledPeersCore(
        &self,
    ) -> ::windows::core::Result<::windows::Foundation::Collections::IVectorView<AutomationPeer>>;
    fn GetAnnotationsCore(
        &self,
    ) -> ::windows::core::Result<
        ::windows::Foundation::Collections::IVector<AutomationPeerAnnotation>,
    >;
    ...
    fn GetDescribedByCore(
        &self,
    ) -> ::windows::core::Result<::windows::Foundation::Collections::IIterable<AutomationPeer>>;
    fn GetFlowsToCore(
        &self,
    ) -> ::windows::core::Result<::windows::Foundation::Collections::IIterable<AutomationPeer>>;
    fn GetFlowsFromCore(
...
pub trait IItemsControlAutomationPeerOverrides_Impl: Sized {
    ...
    ) -> ::windows::core::Result<ItemAutomationPeer>;
}
impl ::windows::core::RuntimeName for IItemsControlAutomationPeerOverrides {
...
impl IItemsControlAutomationPeerOverrides_Vtbl {
    ...
    pub fn matches(iid: &windows::core::GUID) -> bool {
        iid == &<IItemsControlAutomationPeerOverrides as ::windows::core::Interface>::IID
    }
}
