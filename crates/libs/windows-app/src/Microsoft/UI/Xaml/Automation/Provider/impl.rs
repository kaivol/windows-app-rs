    ...
    >() -> IItemContainerProvider_Vtbl {
        ...
        >(
            ...
            match this.FindItemByProperty(
                ::windows_core::from_raw_borrowed(&startafter),
                ::windows_core::from_raw_borrowed(&automationproperty),
...
pub trait ISynchronizedInputProvider_Impl: Sized {
    ...
    fn StartListening(&self, inputtype: super::SynchronizedInputType)
        -> ::windows_core::Result<()>;
}
...
impl ITextEditProvider_Vtbl {
    ...
    pub unsafe fn matches(iid: *const ::windows_core::GUID) -> bool {
        *iid == <ITextEditProvider as ::windows_core::ComInterface>::IID
    }
}
#[doc = "Required features: `\"Windows_Foundation\"`"]
#[cfg(feature = "Windows_Foundation")]
...
impl ITextProvider2_Vtbl {
    ...
    pub unsafe fn matches(iid: *const ::windows_core::GUID) -> bool {
        *iid == <ITextProvider2 as ::windows_core::ComInterface>::IID
    }
}
...
impl ITextRangeProvider_Vtbl {
    ...
    >() -> ITextRangeProvider_Vtbl {
        ...
        >(
            ...
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
            match this.Compare(::windows_core::from_raw_borrowed(&textrangeprovider)) {
                ::core::result::Result::Ok(ok__) => {
                    ::core::ptr::write(result__, ::core::mem::transmute_copy(&ok__));
                    ::windows_core::HRESULT(0)
                }
        ...
        >(
            ...
            match this.CompareEndpoints(
                endpoint,
                ::windows_core::from_raw_borrowed(&textrangeprovider),
                targetendpoint,
            ) {
                ::core::result::Result::Ok(ok__) => {
                    ::core::ptr::write(result__, ::core::mem::transmute_copy(&ok__));
...
impl ITextRangeProvider2_Vtbl {
    ...
    pub unsafe fn matches(iid: *const ::windows_core::GUID) -> bool {
        *iid == <ITextRangeProvider2 as ::windows_core::ComInterface>::IID
    }
}
...
impl ITransformProvider2_Vtbl {
    ...
    pub unsafe fn matches(iid: *const ::windows_core::GUID) -> bool {
        *iid == <ITransformProvider2 as ::windows_core::ComInterface>::IID
    }
}
