...
unsafe impl ::windows_core::ComInterface for INotifyCollectionChanged {
    const IID: ::windows_core::GUID =
        ::windows_core::GUID::from_u128(0x28b167d5_1a31_465b_9b25_d5c3ae686c40);
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows_core::ComInterface for INotifyCollectionChangedEventArgs {
    const IID: ::windows_core::GUID =
        ::windows_core::GUID::from_u128(0x4cf68d33_e3f2_4964_b85e_945b4f7e2f21);
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows_core::ComInterface for INotifyCollectionChangedEventArgsFactory {
    const IID: ::windows_core::GUID =
        ::windows_core::GUID::from_u128(0xb30c3e3a_df8d_44a5_9a38_7ac0d08ce63d);
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows_core::ComInterface for NotifyCollectionChangedEventHandler {
    const IID: ::windows_core::GUID =
        ::windows_core::GUID::from_u128(0xca10b37c_f382_4591_8557_5e24965279b0);
}
