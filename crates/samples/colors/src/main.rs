...
fn sample_main() -> Result<()> {
    ...
    println!("\x1b[38;2;{};{};{}m Sky Blue \x1b[0m", color.R, color.G, color.B);

    let color = Colors::SeaGreen()?;
    println!("\x1b[38;2;{};{};{}m Sea Green \x1b[0m", color.R, color.G, color.B);

    let color = Colors::SeaShell()?;
    println!("\x1b[38;2;{};{};{}m Sea Shell \x1b[0m", color.R, color.G, color.B);

    let color = ColorHelper::FromArgb(255, 247, 76, 0)?;
    println!("\x1b[38;2;{};{};{}m Ferris 🦀 \x1b[0m", color.R, color.G, color.B);
